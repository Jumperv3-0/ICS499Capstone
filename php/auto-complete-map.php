...
function addMarkers($placeData, $gsaleData) {
  ...
  // FIXME: home was $gsaleData[$i][0] laptop is $gsaleData[0][$i]
// google.maps.event.addDomListener(document.getElementById('sale0'), 'click', function() { // map.setCenter(new google.maps.LatLng(10.23, 123.45)); // });
