  ...
  <body>
    <script>
      ...
      function addDate() {
        ...
        //        o.insertBefore(anotherButton, document.getElementById('add_date'));
        var txt = "";
        var i;

        for (i = 0; i < o.length; i++) {
          txt = txt + o[i].nodeName + "<br>";
        }
        //        document.getElementById("new_text").innerHTML = txt; // // var children = document.getElementById('date-time').childNodes; // document.insertBefore()
